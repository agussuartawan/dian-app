...
@section('nama-form', 'Data Komisi')
@section('content')


    @if (session('Succes'))
        <p class="alert alert-success">{{ session('Succes') }}</p>
    @endif
    @if (session('Error'))
    ...
    <div class="card card-default">
        <div class="card-header">
            ...
            <div class="form-group mr-1">
                ...
                <div class="form-group mr-1">
                    <a class="btn btn-primary" href="{{ route('komisi.create') }}">Hitung Komisi</a>
                </div>
    ...
    <div class="card-header">
        ...
        <div class="form-inline">
            ...
            @if ($pasfilter)
                <div class="form-inline">
                    <div class="form-group mr-1">
                        <form id="tgl" method="GET" action="{{ route('laporan-slip-komisi') }}" target="_blank">
                            <input type="text" name="from" id="fromDate" hidden>
                            <input type="text" name="to" id="toDate" hidden>
                            <button id="passtgl" class="btn btn-primary">Print Semua Slip</button>
                        </form>
                    </div>
                </div>
            @endif
